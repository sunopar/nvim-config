...
_G.packer_plugins = {
  ...
  ["aerial.nvim"] = {
    ...
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/aerial.nvim",
  ...
  ["cmp-vsnip"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/cmp-vsnip",
    url = "https://github.com/hrsh7th/cmp-vsnip"
  },
  ["dashboard-nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/dashboard-nvim",
    url = "https://github.com/glepnir/dashboard-nvim"
  },
  ["diffview.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/diffview.nvim",
    url = "https://github.com/sindrets/diffview.nvim"
  },
  ["efmls-configs-nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/efmls-configs-nvim",
  ...
  ["hop.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/hop.nvim",
  ...
  ["lualine-lsp-progress"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/lualine-lsp-progress",
  ...
  ["nvim-gps"] = {
    ...
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nvim-gps",
    url = "https://github.com/SmiteshP/nvim-gps"
  },
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["schemastore.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/schemastore.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-bbye",
    url = "https://github.com/moll/vim-bbye"
  },
  ["vim-vsnip"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-vsnip",
